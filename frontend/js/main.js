...
const favoritesUpdata = favorites.filter(f => f != id)

  sessionStorage.setItem('favorites22',JSON.stringify(favoritesUpdata))
}else{
  favorites.push(id)
...
console.log(sessionStorage.getItem('favorites22'));
}
